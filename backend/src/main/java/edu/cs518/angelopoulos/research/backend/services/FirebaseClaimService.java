...
import edu.cs518.angelopoulos.research.backend.security.UserRole;
...
/**
 * Service for validating a user's claims contained in their firebase ID token.
 */
@Service
public class FirebaseClaimService {
     ...
     */
    public ApiFuture<Void> addUserRoleAsync(String userId, UserRole role) throws UserRoleAlreadyAddedException, FirebaseAuthException {
     ...
     */
    public ApiFuture<Void> removeUserRoleAsync(String userId, UserRole role) throws UserRoleNotAddedException, FirebaseAuthException {
        Map<String, Object> userRoles = getCustomClaims(userId);
